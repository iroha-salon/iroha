...
const contentData = {
    ...
    menu: [
        ...
        { name: "6th sennse healing ロングコース", time: "60分", price: "14,800円", fullDesc: "レイキを受けたことのある方、じっくりとレイキを感じてリラックスされたい方におすすめのコースです。" },
        { name: "6th sense healing リラックスコース", time: "75分", price: "12,800円", fullDesc: "レイキヒーリングをゆったりとくつろいでいただくメニューとなります。<br>不眠の方やゆっくり休まれたい方は睡眠の質が異なりますのでお勧めです。<br>カウンセリングシートを書いていただき、足浴を行います。<br>着衣のままゆっくりと横になっていただき手を当てていきます。<br>終了後にはハーブティーを取っていただき、体調のことをお伝えしていきます。<br><br>全体で90～120分時間をいただいております。" },
        { name: "6th sense healing スタンダードコース", time: "120分", price: "9,800円", fullDesc: "レイキヒーリングを受けられたことのある方におすすめのコースとなります。<br>不眠の方やゆっくり休まれたい方は睡眠の質が異なりますのでお勧めです。<br>カウンセリングシートを書いていただき、足浴を行います。<br>着衣のままゆっくりと横になっていただき手を当てていきます。<br>終了後にはハーブティーを取っていただき、体調のことをお伝えしていきます。<br><br>全体で90～120分時間をいただいております。" },
        { name: "満月・新月healing（2回1セット）", time: "60分", price: "18,000円", fullDesc: "満月・新月に2回1set行うことで、心の開放と浄化、スタートのセットヒーリング＋体調や気持ちを整えていきます。<br>満月・新月時にはアロマオイルは異なり香りも楽しめます。<br>初めにカウンセリング15分、施術60分、終了時にはハーブティーを飲んでいただき全体で90～120分程です。<br>1か月2回のタイミングがおすすめですが、月をまたいでも可能です。セットメニューとなります。" },
        ...
        { name: "【オプション】四柱推命鑑定", time: "15分", price: "1,500円", fullDesc: "（プチ鑑定）<br>四柱推命鑑定を行い、お客様の特徴や才能、強みについてアドバイスしたり、変化のきっかけやタイミングなどをご案内します。転職・引っ越し・結婚など転機に自分自身の強みを知ることで自信につながります。" },
        { name: "【オプション】カードリーディング", time: "1枚引き", price: "500円", fullDesc: "カードを1枚引いていただき、お客様のご希望内容に合わせてアドバイスいたします。" },
